  ...
  return (
    <main className="mx-auto max-w-2xl w-full px-6 py-12 flex-1">
      ...
      <header className="mb-8">
        <h1 className="text-2xl font-semibold tracking-tight">Create a secure listing</h1>
        <p className="text-neutral-400 mt-1.5 text-sm leading-relaxed">
          Funds sit in a Solana escrow until the buyer confirms delivery. TrustLayer&apos;s AI flags risk along
          the way.
        </p>
      </header>
      ...
      {!listingId && priorListings.length > 0 && (
        <div className="mt-10 border-t border-neutral-800 pt-6">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-sm font-semibold text-neutral-300">Recent listings</h2>
            <button
              onClick={handleReset}
